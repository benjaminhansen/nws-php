...
class LatestObservations
{
    ...
    public function barometricPressure(string $unit = "in", int $decimal_points = 0): int|float
    {
        return match($unit) {
    ...
    public function visibility(string $unit = "ft", int $decimal_points = 0): int|float
    {
        return match($unit) {
